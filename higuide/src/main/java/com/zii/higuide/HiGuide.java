...
import com.zii.higuide.GuideView.RemoveCallback;
...
public class HiGuide {
  ...
  public HiGuide addHightLight(View view, int[] expand, @Shape int shape, Tips tips) {
  ...
  public void show() {
    ...
    mGuideView.setRemoveCallback(new RemoveCallback() {
      @Override
